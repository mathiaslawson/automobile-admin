                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border mb-lg-0">
                                                    <CardBody>
                                            ...
                                            <Col xxl={4}>
                                                ...
                                                {/* <!-- Right Ribbon --> */}
                                                <div className="card ribbon-box border right mb-lg-0">
                                                    <CardBody>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border mb-lg-0 right">
                                                    <CardBody>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border ribbon-fill mb-lg-0">
                                                    <CardBody>
                                            ...
                                            <Col xxl={4}>
                                                ...
                                                {/* <!-- Right Ribbon --> */}
                                                <div className="card ribbon-box border ribbon-fill right mb-lg-0">
                                                    <CardBody>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border overflow-hidden mb-lg-0">
                                                    <div className="card-body text-muted">
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box right border overflow-hidden mb-lg-0">
                                                    <div className="card-body text-muted">
                                                        <div className="ribbon ribbon-info ribbon-shape trending-ribbon">
