...
import { DefaultButtonsExample, OutlineButtonsExample, RoundedButtonsExample, SoftButtonsExample, GradientButtonsExample, AnimationButtonsExample, LabelButtonsExample, SizeButtonsExample, WidthButtonsExample, TagButtonsExample, GridButtonsExample, CheckButtonsExample, GroupButtonsExample, IconButtonsExample, ToolbarButtonsExample, GroupsizingButtonsExample, VerticalButtonsExample, GhostButtonsExample, LoadingbuttonsExample, BorderButtonsExample, CustomToggleButtonsExample, CustomSizingExample, BaseClassExample, FocusRingExample, FocusRingUtilityExample } from './UiButtonCode';
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Button className='shadow-none' color="primary" outline > Primary </Button>
                                            <Button className='shadow-none' color="secondary" outline > Secondary </Button>
                                            <Button className='shadow-none' color="success" outline > Success </Button>
                                            <Button className='shadow-none' color="info" outline > Info </Button>
                                            <Button className='shadow-none' color="warning" outline > Warning </Button>
                                            <Button className='shadow-none' color="danger" outline > Danger </Button>
                                            <Button className='shadow-none' color="dark" outline > Dark </Button>
                                            <Button className='shadow-none' color="light" outline > Light </Button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{ height: "275px" }}>
